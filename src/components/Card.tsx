    ...
    return (
        <FadeInSection>
            <a
                ...
                <div className="w-fit h-fit shrink-0 hover:scale-105 bg-slate-50 border-2 border-neutral-600 p-5 m-5 hover:shadow-lg z-0 group rounded-lg">
...

                    {
                        props.tag.split(',')
                            ...
                            .map((tag: any) => {
                                return (
                                    <p
                                        className={`${props.tagcolor} mt-2 text-sm font-bold rounded-full w-fit px-4 py-0.5 z-10 text-white hover:opacity-70`}>
                                        {tag}
                                    </p>
                                )
                            })}
